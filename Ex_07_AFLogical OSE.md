...
##  Aim
To extract and analyze data from an **Android device** using **AFLogical OSE**, an free to use forensic acquisition tool, for recovering call logs, contacts, SMS, messages, and other device data.


##  Description
**AFLogical OSE (Open Source Edition)** is an Android forensic acquisition tool developed by **viaForensics**.  
It is designed to extract logical data (contacts, call logs, SMS, MMS, etc.) from Android devices without rooting them.  
...
1. **Install ADB:**
   ...
   - Add the SDK path to your system environment variables in settings.  
...
1. **Connect the Device:**
   - Use a USB cable to connect the Android phone to the forensic workshop / laptop.  
...
##  Result
Successfully extracted data from the Android device using AFLogical OSE.Contacts, call logs, and SMS data were retrieved and exported into csv format for analysis. All extracted evidence was preserved securely for further forensic examination in our forensic workshop / laptops.
